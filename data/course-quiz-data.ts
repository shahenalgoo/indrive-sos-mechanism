...
export const courseAndQuizData: CourseAndQuizSchema[] = [
    {
        course: {
            ...
            body: "Follow the course and score 100% to get a badge displayed on your profile publicly!",
        }
    },
    {
        course: {
    ...
    },
    {
        quiz: {
            ...
            options: [
                "Request the driver's criminal background check.",
    ...
    },
    {
        course: {
            title: "During the ride",
            body: "<p>" +
                "Treat your driver's vehicle with care: don't smoke, eat, or drink anything but water in the car.<br><br>" +
                "Feel free to ask the driver to change the music, adjust the temperature, or close the window. Just make sure your request works for both of you.<br><br>" +
                "If you do not feel comfortable asking, you can set your preferences in <strong>Mood & Preferences</strong>. They will appear on your public profile.<br><br>",
            jsx: true
        }
    },
    {
        quiz: {
            ...
            options: [
                "SOS & Emergency (Shield Icon)",
                "Precautions (Triangle Icon)",
                "Mood & Preferences",
                "Profile Settings"
            ],
            correct_answer: 1,
    ...
    },
    {
        quiz: {
            ...
            question: "How can you access the customer support messaging and police assistance features?",
            options: [
                "SOS & Emergency (Shield Icon)",
                "Precautions (Triangle Icon)",
                "Mood & Preferences",
    ...
    },
    {
        course: {
            ...
            body: "<p>Each person you encounter has a unique story, facing their own triumphs and challenges.<br><br>So, let's create an atmosphere of kindness and understanding, reminding each other that we are all humans.<br><br>"
                + "</p>",
            jsx: true
        }
    },
